  ...
  return (
    ...
    <RotationImage type="content" parentClass="flex" maxTilt="10">
      <a
        ...
        className="flex flex-1 items-center justify-center  border-2 border-transparent xs:hover:border-grey rounded-full my-4 xs:p-8 md:px-16 md:py-12 group font-semibold"
        style={{ color: color}}
      >
