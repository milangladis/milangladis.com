  ...
  return (
    <div className="flex flex-col gap-12">
      <div className="flex items-center md:items-start md:flex-col gap-12">
        <Image src={`/images/portfolio/portfolioIcons/${team.logo}.svg`} alt={team.logo} width={32} height={32} className="h-32 w-32" />
