    ...
    <>
        ...
        <div className='navigation flex flex-col md:flex-row navigation flex-1 justify-center md:justify-end gap-16 list-none align-middle flex-wrap '>            
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <RotationImage type="content" maxTilt="10">
              <a href="/cv.pdf" target="_blank" className='flex w-fit h-48 gap-8 px-16 items-center justify-center rounded-full border-2 border-transparent hover:border-grey transition group'>
      ...
      {isModalOpen && (
        <div className="fixed top-0 left-0 right-0 bottom-0 z-50 flex items-center justify-center" >
          <div className="absolute top-0 left-0 w-full h-full bg-[#5214E1]/90 z-1" onClick={() => setIsModalOpen(!isModalOpen)}></div>
          <div className="relative w-full max-w-6xl m-32 bg-white rounded-16 p-48 z-20">
...
function SideProject({...props}) {
  return (
    <>
      {props.href ?
        <a href={props.href} target="_blank" className="group w-full sm:w-[50%] md:w-[33.3%] mb-32 flex flex-col" rel="noreferrer">
